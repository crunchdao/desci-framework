...
in the financial market, the scope of this project is much broader and its potential in the public sector should not be neglected. Worth mentioning, for example, [the General Index](https://archive.org/details/GeneralIndex), [Impact Certificates](https://impactmarkets.io/).
...
- There should be reinforcement learning frameworks that are agnostic wrt this low level objective, which is evolving with the model in the maximization of a score. Study.
...
- How can people add different datasets? Mention Weavechain and DeSci Collaborative Data, and https://oceanprotocol.com/
...
- Implement in Python the pipeline that we use in the backend for the computation of the performance and the population of the paper.html page with video and audio on one of my papers to describe the value of the meta science framework for research. 
